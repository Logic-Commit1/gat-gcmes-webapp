...
class CanvassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create canvass" do
    assert_difference("Canvass.count") do
      post canvasses_url, params: { canvass: { company_id: @canvass.company_id, uid: @canvass.uid } }
    end
  ...
  test "should update canvass" do
    patch canvass_url(@canvass), params: { canvass: { company_id: @canvass.company_id, uid: @canvass.uid } }
